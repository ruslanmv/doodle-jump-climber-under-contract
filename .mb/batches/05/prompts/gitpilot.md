...
This is **Batch 05**. It builds on commit mc-cf84ff722c6e. Implement only what this batch requires — nothing else.
...
## Task TASK-002: Juice: particles, parallax, sound, screen-shake
