...
This is **Batch 06**. It builds on commit mc-b133e1b1d466. Implement only what this batch requires — nothing else.
...
## Task TASK-002: Meta: start, game-over, high score, difficulty, boss
